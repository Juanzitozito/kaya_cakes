        ...
        <div class="card me-3 mt-2" style="width: 14rem;">
            ...
            <div class="card-body">
                ...
                @if (isset(Auth::user()->admin) && Auth::user()->admin != 0)
                    <a href="/sabores/update/{{ $sabor->id }}" class="btn"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="/sabores/delete/{{ $sabor->id }}" class="btn"><svg xmlns="http://www.w3.org/2000/svg"
